...
public class IngameRenderer {
	...
	public static float joystick_x = 0.0F;
	public static float joystick_y = 0.0F;
	...
	public static void render2D() {
		...
		ClassicByteRenderer.drawText(IngameRenderer.CHAT_TOPLEFT, 0, (int)(ClassicByte.view.renderer.height*0.04F), (int)(ClassicByte.view.renderer.height*0.06F));
		...
		for(int k=11;k!=20;k++) {
			...
			if(ClassicByte.view.renderer.chatmananger.lines.get(k)!=null && !Options.colored_chat) {
				ClassicByteRenderer.drawText(ClassicByte.view.renderer.chatmananger.lines.get(k), 0, (int)((k+1-11)*ClassicByte.view.renderer.height*0.04F+ClassicByte.view.renderer.height-10*ClassicByte.view.renderer.height*0.04F)-TextureManager.getBitmap(27).getHeight(), (int)(ClassicByte.view.renderer.height*0.058F));
			}
		}
		...
		if(IngameRenderer.current_button==3) {
			...
			for(int k=0;k!=ClassicByte.view.renderer.players.size();k++) {
				...
				ClassicByteRenderer.drawRect(x_offset-ClassicByte.view.renderer.width*0.01F, y_offset-ClassicByte.view.renderer.height*0.04F, x_offset+ClassicByte.view.renderer.width*0.28F, y_offset, ClassicByte.view.standard_paint);
				ClassicByte.view.standard_paint.setColor(Color.WHITE);
		...
		if(IngameRenderer.current_button==4) {
			ClassicByteRenderer.drawBitmap(TextureManager.getBitmap(35),(ClassicByte.view.renderer.width-TextureManager.getBitmap(35).getWidth()),ClassicByte.view.renderer.height-TextureManager.getBitmap(35).getHeight(),ClassicByte.view.standard_paint);
		} else {
			ClassicByteRenderer.drawBitmap(TextureManager.getBitmap(34),(ClassicByte.view.renderer.width-TextureManager.getBitmap(34).getWidth()),ClassicByte.view.renderer.height-TextureManager.getBitmap(34).getHeight(),ClassicByte.view.standard_paint);
		}
		
		ClassicByteRenderer.drawBitmap(TextureManager.getBitmap(36), 0, ClassicByte.view.renderer.height-(int)(ClassicByte.view.renderer.width*0.2F), ClassicByte.view.standard_paint);
		ClassicByteRenderer.drawBitmap(TextureManager.getBitmap(37), (int)((ClassicByte.view.renderer.width*0.2F-ClassicByte.view.renderer.width*0.08F)*0.5F), ClassicByte.view.renderer.height-(int)(ClassicByte.view.renderer.width*0.2F)+(int)((ClassicByte.view.renderer.width*0.2F-ClassicByte.view.renderer.width*0.08F)*0.5F), ClassicByte.view.standard_paint);
		...
		TextureManager.bindTexture(36);
		ClassicByteRenderer.drawRect(0,ClassicByte.view.renderer.height-ClassicByte.view.renderer.height/2,ClassicByte.view.renderer.height/2,ClassicByte.view.renderer.height/2);
		TextureManager.bindTexture(37);
		ClassicByteRenderer.drawRect((joystick_x+0.5F)*ClassicByte.view.renderer.height/2-ClassicByte.view.renderer.height/12,(joystick_y+0.5F)*ClassicByte.view.renderer.height/2+ClassicByte.view.renderer.height-ClassicByte.view.renderer.height/2-ClassicByte.view.renderer.height/12,ClassicByte.view.renderer.height/6,ClassicByte.view.renderer.height/6);
	}
